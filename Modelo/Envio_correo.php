...
class Envio_correo
{
    public static function enviar_correo()
    {
        ...
        try {
            ...
            $mail->addAddress('diegobautista.letter1@gmail.com', 'Diego');     //Add a recipient
            // $mail->addAddress('ellen@example.com');               //si queremoos enviar a más correos 
            /*$mail->addReplyTo('info@example.com', 'Information');
    $mail->addCC('cc@example.com');
    $mail->addBCC('bcc@example.com');*/ //DE MOMENTO ESTO NO ES IMPORTANTE 
